import AccountIcon from "@/assets/svg/header/account.svg";
import {Popover, PopoverContent, PopoverTrigger} from "@/components/ui/popover";
import {ChevronDown} from "lucide-react";
import {FiPhone, FiMail} from "react-icons/fi";

const AccountPopover: React.FC<{email?: string; phone?: string}> = ({
    email,
    phone,
}) => {
    return (
            ...
            <PopoverContent
                ...
                <div className="  flex-col justify-start items-start gap-2 lg:gap-5 inline-flex">
                    <div className="text-light-alpha">
                        <p className="text-sm font-semibold mb-2">Accounts</p>
