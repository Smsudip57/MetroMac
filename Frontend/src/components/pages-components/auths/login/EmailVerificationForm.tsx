...
border border-white/30 backdrop-blur-[20.8px] flex flex-col justify-between"
    >
      ...
      <p className="text-center text-white mb-6">
        Enter the 6-digit code sent to your email. Kindly check your spam folder
        if you don&apos;t see it.
      </p>
      ...
      <button
        ...
        onClick={onResend}
        className="text-center mt-4 text_highlight-emerald-lightest font-semibold underline disabled:opacity-50"
      >
        {isResending
          ? "Resending..."
          : resendCountdown > 0
